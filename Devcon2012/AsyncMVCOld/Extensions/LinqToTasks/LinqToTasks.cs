...
namespace AsyncMVCOld
{
	...
	{
		public static Task<TResult> Select<TResult>(this Task source, Func<object, TResult> selector)
		{
			// Validate arguments
			...
			return source.ContinueWith(t => selector(null), TaskContinuationOptions.NotOnCanceled);
		}
